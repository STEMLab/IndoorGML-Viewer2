...
SetIndoorGMLCommand.prototype = {
  ...
  calCenter : function(maxmin_xyz) {
	...
	transformCoordinates : function(myvertices) {
      ...
      for (var i = 0; i < myvertices.length / 3; i++) {
          myvertices[i * 3] = Math.floor( myvertices[i * 3] * 10000) / 10000
          myvertices[i * 3 + 1] = Math.floor( myvertices[i * 3 + 1] * 10000) / 10000
          myvertices[i * 3 + 2] = Math.floor( myvertices[i * 3 + 2] * 10000) / 10000
      }
  },
